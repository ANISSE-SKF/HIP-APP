...
st.markdown("Dépose ton fichier PDF ci-dessous. Les données seront extraites et converties en Excel avec le format exact attendu.")
...
def extract_data_from_pdf(pdf_bytes):
    ...
    data["ElongatFracture"] = ["4", "4"]
    data["ElongafterFracture"] = ["5", "5"]
...
if uploaded_file:
    with st.spinner("📤 Traitement du fichier..."):
        ...
        st.download_button(
            ...
            data=excel_file,
            file_name="resultats_corrige.xlsx",
